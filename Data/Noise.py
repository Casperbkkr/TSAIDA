...
new_dir = pathlib.Path("/Users/casperbakker/PycharmProjects/PythonProject/Data/Synth_data/Noise/","Noise_data_" + str(epoch_time))
...
np.save("/Users/casperbakker/PycharmProjects/PythonProject/Data/Synth_data/Noise/Noise_data_" + str(epoch_time) + "/data", sin_out)
np.save("/Users/casperbakker/PycharmProjects/PythonProject/Data/Synth_data/Noise/Noise_data_" + str(epoch_time) + "/anom", anom_out)